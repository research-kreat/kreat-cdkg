...
Found 6287 documents to process in the 'cdkg' collection.
/Users/user/Downloads/kreat-cdkg/.venv/lib/python3.11/site-packages/pymongo/synchronous/collection.py:1945: UserWarning: use an explicit session with no_cursor_timeout=True otherwise the cursor may still timeout after 30 minutes, for more info see https://mongodb.com/docs/v4.4/reference/method/cursor.noCursorTimeout/#session-idle-timeout-overrides-nocursortimeout
  return Cursor(self, *args, **kwargs)
Enriching Patents:   0%|                                                                                                                        | 0/6287 [00:00<?, ?it/s]
Traceback (most recent call last):
  File "/Users/user/Downloads/kreat-cdkg/set_taxonomy.py", line 127, in <module>
    enrich_patent_data(mongo_client, DB_NAME)
  File "/Users/user/Downloads/kreat-cdkg/set_taxonomy.py", line 46, in enrich_patent_data
    for patent in tqdm(patent_cursor, total = total_docs, desc = "Enriching Patents"):
  File "/Users/user/Downloads/kreat-cdkg/.venv/lib/python3.11/site-packages/tqdm/std.py", line 1181, in __iter__
    for obj in iterable:
  File "/Users/user/Downloads/kreat-cdkg/.venv/lib/python3.11/site-packages/pymongo/synchronous/cursor.py", line 1284, in __next__
    return self.next()
           ^^^^^^^^^^^
  File "/Users/user/Downloads/kreat-cdkg/.venv/lib/python3.11/site-packages/pymongo/synchronous/cursor.py", line 1260, in next
    if len(self._data) or self._refresh():
                          ^^^^^^^^^^^^^^^
  File "/Users/user/Downloads/kreat-cdkg/.venv/lib/python3.11/site-packages/pymongo/synchronous/cursor.py", line 1208, in _refresh
    self._send_message(q)
  File "/Users/user/Downloads/kreat-cdkg/.venv/lib/python3.11/site-packages/pymongo/synchronous/cursor.py", line 1102, in _send_message
    response = client._run_operation(
               ^^^^^^^^^^^^^^^^^^^^^^
  File "/Users/user/Downloads/kreat-cdkg/.venv/lib/python3.11/site-packages/pymongo/_csot.py", line 125, in csot_wrapper
    return func(self, *args, **kwargs)
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/Users/user/Downloads/kreat-cdkg/.venv/lib/python3.11/site-packages/pymongo/synchronous/mongo_client.py", line 1917, in _run_operation
    return self._retryable_read(
           ^^^^^^^^^^^^^^^^^^^^^
  File "/Users/user/Downloads/kreat-cdkg/.venv/lib/python3.11/site-packages/pymongo/synchronous/mongo_client.py", line 2026, in _retryable_read
    return self._retry_internal(
           ^^^^^^^^^^^^^^^^^^^^^
  File "/Users/user/Downloads/kreat-cdkg/.venv/lib/python3.11/site-packages/pymongo/_csot.py", line 125, in csot_wrapper
    return func(self, *args, **kwargs)
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/Users/user/Downloads/kreat-cdkg/.venv/lib/python3.11/site-packages/pymongo/synchronous/mongo_client.py", line 1993, in _retry_internal
    ).run()
      ^^^^^
  File "/Users/user/Downloads/kreat-cdkg/.venv/lib/python3.11/site-packages/pymongo/synchronous/mongo_client.py", line 2730, in run
    return self._read() if self._is_read else self._write()
           ^^^^^^^^^^^^
  File "/Users/user/Downloads/kreat-cdkg/.venv/lib/python3.11/site-packages/pymongo/synchronous/mongo_client.py", line 2891, in _read
    return self._func(self._session, self._server, conn, read_pref)  # type: ignore
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/Users/user/Downloads/kreat-cdkg/.venv/lib/python3.11/site-packages/pymongo/synchronous/mongo_client.py", line 1908, in _cmd
    return server.run_operation(
           ^^^^^^^^^^^^^^^^^^^^^
  File "/Users/user/Downloads/kreat-cdkg/.venv/lib/python3.11/site-packages/pymongo/synchronous/helpers.py", line 47, in inner
    return func(*args, **kwargs)
           ^^^^^^^^^^^^^^^^^^^^^
  File "/Users/user/Downloads/kreat-cdkg/.venv/lib/python3.11/site-packages/pymongo/synchronous/server.py", line 227, in run_operation
    _check_command_response(first, conn.max_wire_version)
  File "/Users/user/Downloads/kreat-cdkg/.venv/lib/python3.11/site-packages/pymongo/helpers_shared.py", line 250, in _check_command_response
